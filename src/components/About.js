    ...
    <div className="top-container">
      ...
      <div className='text-container'>
        <p className='text'>
          ...
          For example, in the board below, the correct move is <span className='special-font'>Bb5</span>.
        </p>
      </div>
      ...
      <div className='text-container'>
        <p className='text'>
          ...
          the <span className='special-font'>White</span> or <span className='special-font'>Black</span> options 
          to change the side of the prompted moves. This also changes the orientation of the board.
          Selecting <span className='special-font'>Random</span> would make the board randomly alternate between white and black.
          Checking the <span className='special-font'>Show Coordinates</span> option toggles the file and rank indicators on the board.
        </p>
